...
export function Allen({className}){
    return <div className={`${className} font-semibold`}>
        <div className="bg-green-400 flex justify-center items-center gap-2 p-3 cursor-pointer">
        ...
        <div className="bg-gray-200 h-100 grid justify-items-center items-center mb-15">
            <Card className={"w-230 cursor-pointer"}><img src="Screenshot 2025-06-11 233657.png" className="rounded-4xl"></img></Card>
        </div>
        <Courses className={""}/>
        </div>
}